...
public class CSVReader implements Serializable {
    ...
    public String[] readRow() throws IOException, CSVFormatException {
            ...
            switch (state) {
                    ...
                    switch (character) {
                        ...
                        case '"':
                            ...
                            if (!fieldHasData) {
                                ...
                                throw new CSVFormatException("A field cannot have a quote in the middle of the field unless surrounded by quotes");
                            }
                            break;
                        ...
                        case '\r':
                            ...
                            if (nextChar == '\n') {
                                ...
                                throw new CSVFormatException("Standalone CR detected");
                            }
                ...
                case END_QUOTE:
                    ...
                    switch (character) {
                        ...
                        default:
                            throw new CSVFormatException("Character after end quote must be comma, newline, or another quote");
                    }
                    break;
            }
        }
        ...
        if (state == State.IN_QUOTE) {
            throw new CSVFormatException("Unclosed quote at end of file");
        }

        //If we reached END_QUOTE state but didn't get a valid terminating character, it's an error
        if (state == State.END_QUOTE) {
            throw new CSVFormatException("Quote incorrectly terminated at end of file");
        }
        ...
        return (!hasReadAnyChar && row.isEmpty()) ? null : row.toArray(new String[0]);
    }
}